...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="default" select="'http://localhost:8080/resource/'" />
    ...
    <xsl:template match="abstract">
    	<rdf:Description rdf:about="textual-entity">
    		<swrc:abstract><xsl:value-of select="p/text()" /></swrc:abstract>	
    	</rdf:Description>
    </xsl:template>
    ...
    <xsl:template match="body">
    	<xsl:for-each select="sec">
    		...
    		<rdf:Description rdf:about="textual-entity">
    			<swrc:chapter rdf:resource="textual-entity#section-{$id}"/>
    		</rdf:Description>
    		<rdf:Description rdf:about="textual-entity#section-{$id}">
